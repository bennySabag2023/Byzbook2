...
export default function Password (props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            var res = await fetch('http://localhost:3001/login', requestOptions)
        ...
        <div className="container">
            <div className="col-md-4 col-md-offset-4">
				...
				<div className="panel panel-info">
                    ...
                    <div className="panel-body" style={{ maxHeight: "200px", marginTop: "-5%", 
                    marginRight: "0%", width: "100%", backgroundColor: "transparent" }}>
							<label className="control-label">שם משתמש</label>
							<div className="input-group has-feedback input-group-sm" style={{ direction: 'ltr' }}>
