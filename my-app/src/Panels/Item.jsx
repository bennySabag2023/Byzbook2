            ...
            <div className="panel panel-info">
                ...
                <div className="panel-body">
                    ...
                    <div className="properties" style={{ minHeight:'40px'}}>                     
                        ...
                        <Consumer>
                            { (value) =>
                            <button type="button" className="center-block btn btn-primary" data-toggle="modal" data-target="#myModal"
                            onClick={e => value(props.data)} style={{marginTop: "4%", marginBottom: '0%'}}>דיווח</button>   
                            }
                        </Consumer>
                    </div>
                </div>
